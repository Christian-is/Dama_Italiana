...
public class Gioco {
    ...
    public int gioca(final String comando) {
        int flag = 0; //1 c'è un vincitore, -1 uscita dalla partita, 0 partita in corso, -2 patta
        ...
        } else if (comando.compareTo(Comandi.PATTA) == 0) {
            if (ComunicazioneEsterna.confermaPatta()) {
                flag = -2;
                return flag;
            }
    ...
    //metodo che verifica la presenza di un vincitore e la fine della partita
