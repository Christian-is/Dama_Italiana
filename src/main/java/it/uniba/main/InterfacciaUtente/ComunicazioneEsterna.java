...
public final class ComunicazioneEsterna {
    ...
    public static void help() {
        ...
        System.out.println("# patta         La partita finisce in parità.");
    ...
    //metodo che permette di terminare la partita in parità
    public static boolean confermaPatta() {
        boolean partitaFinita = false;
        System.out.println("Sei sicuro di voler offrire una patta? "
                + "Entrambi i giocatori devono essere d'accordo.");
        System.out.print("Digita 'si' per confermare patta, 'no' per annullare. ");
        String risposta = LettoreComandi.getRisposta().toLowerCase(Locale.ROOT);
        while (risposta.compareTo("si") != 0 && risposta.compareTo("no") != 0) {
            System.out.print("Risposta non valida. ");
            System.out.print("Digita 'si' per confermare patta, 'no' per annullare. ");
        ...
        if (risposta.compareTo("si") == 0) {
            ...
            System.out.println("Patta annullata.");
        }
        return partitaFinita;
    }
